" Custom Vim color file (Based on DesertInk).
...
if has("gui_running") || &t_Co >= 88
  ...
  call <SID>X("CursorLine", "", "363636", "", "", "236", "none")
  call <SID>X("CursorColumn", "", "363636", "", "", "236")

  call <SID>X("ColorColumn", "", "303030", "", "235")
  ...
  call <SID>X("LineNr", "3e3e3e", "181818", "", "246")
